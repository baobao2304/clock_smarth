    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          padding: EdgeInsets.zero, disabledForegroundColor: themeColor.textColor.withOpacity(0.38), disabledBackgroundColor: themeColor.textColor.withOpacity(0.12),
          elevation: 0,
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          foregroundColor: themeColor.textColor, shape: const RoundedRectangleBorder(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: themeText.getTextTheme.bodyLarge!.copyWith(
